...
def import_data():
    ...
    with app.app_context():
        ...
        stores_csv = pd.read_csv('E:/Web dev/Restaurant-Monitoring-System/app/data/store status.csv', chunksize=batch_size)
        business_hours_csv = pd.read_csv('app/data/Menu hours.csv', chunksize=batch_size)
        timezones_csv = pd.read_csv('app/data/bq-results-20230125-202210-1674678181880.csv', chunksize=batch_size)
